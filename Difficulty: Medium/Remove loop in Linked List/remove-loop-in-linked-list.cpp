...
class Solution {
  public:
    void removeLoop(Node* head) {
        // If the list is empty or has only one node, no loop possible
        ...
        if (slow == fast) {
            ...
            // Move slow and fast pointer at same speed until they meet at loop start
        ...
        // Remove the loop by setting the last node's next to NULL
        fast->next = NULL;
    }
};
